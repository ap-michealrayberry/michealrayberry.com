-- Initial Netlify Database schema for the MRB Public Accountability Project.
-- Governing authority: signed execution agreement and signed amendments.
-- This migration creates no credentials and imports no production records.
