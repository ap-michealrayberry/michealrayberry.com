...
4. A day page is written only when that day has a video **and** all four angle photographs. Incomplete or missed days get a page only after the 10:00 PM ET deadline. The daily sitemap lists **only** days that have HTML.
...
Every commit to `main` is the public history of this record. Use real commit messages, not “Add files via upload.”
